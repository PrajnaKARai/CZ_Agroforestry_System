...
# Once the script works, it should be edited and saved in 'functions' folder to be called by the app.R
...
# Before calling it in app.R, variables must be replaced as per the new formatted input file
